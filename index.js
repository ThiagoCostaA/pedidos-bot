...
app.post('/webhook', (req, res) => {
    ...
    if(intencao === 'VerCardapio'){
        responder = responder + "Nosso cardápio ainda está em elaboração, mas nós vendemos Pizza e Refrigerantes"; 
    }
    else if(intencao === 'verStatus'){
        responder = 'Seu pedido ainda está sendo preparado, por favor aguarde mais um instante';
    }
